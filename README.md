...
> **项目来源**：本项目基于 [Leaderxin/quant-desktop](https://github.com/Leaderxin/quant-desktop) 二次开发，原作者为 **Leaderxin**，遵循 PolyForm Noncommercial License 1.0.0（非商业使用）。本仓库在此基础上做了功能扩展与优化，详见 [关于本仓库](#-关于本仓库)。
...
本仓库是 [Leaderxin/quant-desktop](https://github.com/Leaderxin/quant-desktop) 的二次开发版本，原作者为 **Leaderxin**，原项目遵循 PolyForm Noncommercial License 1.0.0（**仅限非商业使用**）。

### 本版本新增 / 优化

- **自选股分组** —— 支持新建、重命名、删除分组，组内独立排序，顶部工具栏一键切换
- **持仓管理** —— 录入成本价与持仓数量，实时计算浮动盈亏
- **价格预警** —— 为自选股设置上限 / 下限预警，触发后桌面弹窗提醒
- **桌面提醒窗** —— 独立置顶提醒窗口，支持多条排队、点击跳转主窗口
- **通知历史** —— 统一记录预警与系统通知，支持查询与清空
- **全局快捷键** —— 一键显示 / 隐藏浮动行情条，组合键可自定义
- **设置面板重构** —— 集中管理行情调度、窗口尺寸、全局快捷键、提醒与通知

> ⚠️ 本仓库版本线从 `v1.0.0` 重新起算，与原项目的版本号无对应关系。
...
<p align="center">
  <b>QuantDesktop v1.0.0</b> — 免费实时 A 股看盘，从桌面开始。
</p>
