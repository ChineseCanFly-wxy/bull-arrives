...
interface AlertNotice { id: string; signal_id?: string; signal_tag?: string; signal_kind?: string; title: string; body: string; received_at: number; history_version: number; delivery?: Delivery }
